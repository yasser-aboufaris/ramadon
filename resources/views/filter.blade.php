        ...
        <div class="container mx-auto text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
                <div class="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-white/10">
                    <div class="text-3xl font-bold text-amber-400 mb-2">{{ $categoryPercentage }}%</div>
                    <div class="text-gray-400 text-sm">of total recipes are in this category</div>
                </div>
                <div class="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-white/10">
                    <div class="text-3xl font-bold text-amber-400 mb-2">{{ $recipes->count() }}</div>
                    <div class="text-gray-400 text-sm">recipes in this category</div>
                </div>
                <div class="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-white/10">
                    <div class="text-3xl font-bold text-amber-400 mb-2">{{ $averageRecipesPerCategory }}</div>
                    <div class="text-gray-400 text-sm">average recipes per category</div>
                </div>
            </div>
        </div>
    </section>
