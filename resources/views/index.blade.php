    ...
    <nav class="fixed w-full bg-white/5 backdrop-blur-lg border-b border-white/10 z-50">
        <div class="container mx-auto px-6 py-4 flex items-center justify-between">
            <div class="flex items-center space-x-3">
                <svg class="w-8 h-8 text-amber-400 crescent-float" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8 0-.3 0-.6.1-.9 2.3-1.3 4.9-2 7.9-2s5.6.7 7.9 2c.1.3.1.6.1.9 0 4.4-3.6 8-8 8z"/>
                </svg>
            ...
            <div class="flex items-center space-x-8">
                <a href="#" class="text-white/80 hover:text-amber-400 transition-all duration-300 text-sm font-medium">recepes</a>
               
                <div class="relative">
                    <button 
                        onclick="document.getElementById('postForm').classList.toggle('hidden')"
